...
int main(int argc, char *argv[])
{
    ...
    mesh2Mob->SetPosition(Vector(50.0, 0.0, 0.0));      // Mesh AP2 50m away (closer)
    sta1Mob->SetPosition(Vector(5.0, 0.0, 0.0));        // Sayed very close to Mesh AP1
    sta2Mob->SetPosition(Vector(55.0, 0.0, 0.0));       // Sadia very close to Mesh AP2
    ...
    // Mesh topology with two APs connected by point-to-point link
    std::cout << "Mesh topology: Two mesh APs connected + STAs" << std::endl;
