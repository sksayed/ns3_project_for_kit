...
def create_visualizations(df, out_dir="5g_outputs"):
    """Create multi-panel summary plots and save a PNG to out_dir."""
    fig, axes = plt.subplots(2, 3, figsize=(18, 12))
    fig.suptitle('5G Network Flow Analysis', fontsize=16)
    ...
    ax1.set_title('5G Flow Throughput')
    ...
    ax2.set_title('5G Packet Loss Rate')
    ...
    ax3.set_title('5G Average End-to-End Delay')
    ...
    ax4.set_title('5G Average Jitter')
    ...
    ax5.set_title('5G Bytes Transmitted vs Received')
    ax5.legend()
    ...
    ax6.set_title('5G Delay Distribution')
...
if __name__ == "__main__":
    ...
    in_dir = '5g_outputs'
    xml_path = f"{in_dir}/flowmon-5g-playfield-rw.xml"
    ...
    print("Detailed analysis saved to '5g_outputs/flowmon_analysis.csv'")
